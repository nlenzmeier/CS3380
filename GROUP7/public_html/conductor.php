...
<html lang="en">
<head>
  <title>Conductor's Profile</title>
  <meta charset="utf-8">
...
<body>
   ...
   <div class="container">
      <div class="row">
          <div class="col-md-9" id="TrainLog">
        ...
        echo "<div class='panel'>";
            ...
            if (mysqli_connect_errno())
            {
                ...
                $query = "SELECT * FROM conductor WHERE username=?;";
...
//                    }
          ...
          <div class="video">
                <iframe width="100%" height="615" src="https://www.youtube.com/embed/vGCIGEUB32M" frameborder="0" allowfullscreen></iframe>
          </div>
                ...
                <form id="thisIsID" method="post" class="form-horizontal" role="form">
                  ...
                  <div class="form-group">
                    <label  class="col-sm-4 control-label"
                              for="OldPassword">Username</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="password" name="newPass2" class="form-control" placeholder = "Confirm New Password" />
                    </div>
                  </div>
                   <!-- Modal Footer -->
